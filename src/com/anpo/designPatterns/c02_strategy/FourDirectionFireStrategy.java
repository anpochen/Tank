...
//            new Bullet(bulletX, bulletY, direction, baseTank.getGroup(), baseTank.getTankFrame());
            tank.getTankFrame().gameFactory.createBullet(bulletX,bulletY, direction, tank.getGroup(), tank.getTankFrame());
