...
public class BaseTank extends com.anpo.designPatterns.c03_factory.bean.Tank {
    ...
    public BaseTank(int x, int y, Direction direction, Group group, TankFrame tankFrame) {
        this.x = x;
        this.y = y;
